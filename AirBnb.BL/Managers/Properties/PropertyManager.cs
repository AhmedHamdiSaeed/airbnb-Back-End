...
namespace AirBnb.BL.Managers.Properties
{
	public class PropertyManager : IPropertyManager
	{
		...
		public async Task<PropertyDetailsGetDto> GetPropertyDetailsById(int propId)
		{
			...
			result.AppoinmentAvaiable = singleProp.AppointmentsAvailable.Select(app=> new appAvailbletGetDto
			{
				Id=app.Id,
				From = app.From,
				To = app.To,
				PricePerNight=app.PricePerNight,
				TotalProice = (int)(((TimeSpan)(app.To - app.From)).TotalDays) * ((int)app.PricePerNight),
